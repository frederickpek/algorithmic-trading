...
class BollingerBandsStrategy(Strategy):
    ...
    '''
	Long only Bollinger Bands strategy - Reversal Indicator
	Long when current candle closes above upper band, indicating over-bought conditions.
	Close long position when candle closes below lower band, indicating over-sold conditions.
	'''
